...
export function CreateUserForm() {
  ...
  return (
    <form action={formAction} className="mt-3 grid grid-cols-1 gap-3 md:grid-cols-4">
      ...
      <input name="password" type="password" placeholder="Temporary password" required minLength={8} className="rounded-md border border-slate-300 px-2 py-1.5 text-sm" />
